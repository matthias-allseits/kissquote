...
@Component({
  selector: 'app-diversification-strategy-container',
  templateUrl: './diversification-strategy-container.component.html',
  styleUrls: ['./diversification-strategy-container.component.scss']
})
export class DiversificationStrategyContainerComponent {
